...
\begin{tabular}{cc}
	...
	\begin{description}
		...
		\item { \textbf{Completed:} 21/12/2015}\todo{update info before upload}
	\end{description}
	\vfill } &
	\parbox{7cm}{
 	 \vspace{.15cm}
...
\\
\vfill
\noindent{\footnotesize{\textit{The contents of this report is freely accessible, however publication or citation (with source references) is only allowed upon agreement with the authors.}}}
