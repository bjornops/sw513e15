...
\textit{Is it a problem to administrate the moisture of a golf course?}\todo{evaluate this, too short?}

\section{OLD Initializing problem statement}\todo{remove this, redundant, left for comparison reasons}
