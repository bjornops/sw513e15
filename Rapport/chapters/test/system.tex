...
Due to the long range of the radio modules, relaying had to be tested using special code. This meant that one of the sensor node were running code that ignored packets from the main node, to make it become a subnode of the other sensor node used in the test.
