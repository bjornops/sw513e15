...
The number of devices that can be on a Bluetooth network is almost unlimited, and the the built-in interference reduction makes the technology usable for the product. \todo{der bliver snakket om noget indbygget? er det også nævnt i senere kilde eller?}
...
XBees often use the ZigBee protocol. The ZigBee standard\todo{standard or protocol?}  is made for low-power devices, such as the product described in this report\cite{zigbee}.
