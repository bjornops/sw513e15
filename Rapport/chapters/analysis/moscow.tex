...
Should have:
\begin{itemize}
\item Be able to seamlessly add and remove sensors to an existing system (Hot-pluggging).\todo{sensors or devices(nodes)?}
...
\item Have a graphical user interface for presentation of data.\todo{should, perhaps?}
\end{itemize}
