\section{Communication protocols} \label{cha:comprot}\todo{straighten metatext}
...
Time division multiple access(TDMA) is an access method\todo{aren't we studying protocols?} that divides a single channel into smaller time slots.
