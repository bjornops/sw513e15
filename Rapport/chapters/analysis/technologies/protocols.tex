...
The four different protocols is compared in what rute metric they are using, if they are loop free, support of load balancing, how reliable they are, and the estimated throughput.
...
\hline
            & Ad hoc & Rute metrics                                                                     & \begin{tabular}[c]{@{}c@{}}Loop \\ Free\end{tabular} & \begin{tabular}[c]{@{}c@{}}Load \\ balancing\end{tabular} & Reliability & Thoughput                                                                    \\ \hline%cline{1-1}
