...
The sensors are small and therefore easy\todo{Easy..} to bury around the course. But is required to be in close proximity of irrigation valves, which might not be useful everywhere.
...
The size of device allows it to fit into a standard hole-size, making them easy\todo{Easy..} to install on greens where a tool for creating holes are used\cite{turfGuard2}.
