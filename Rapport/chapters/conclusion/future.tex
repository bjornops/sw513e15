...
Finally the system would have to be optimized, when considering power consumption. As it is now the system has not been tested for power consumption \todo{Kilde eller noget}. The nodes should include more sleep functionality to save power when not operating.
