...
\item[{\parbox[t]{0.6\linewidth}{Packet(PacketType packetTypeInput, \\ uint16\_t addresserInput, \\ uint16\_t addresseeInput, \\ uint16\_t originInput, \\ uint16\_t sensor1Input, \\ uint16\_t sensor2Input, \\ uint16\_t sensor3Input)}}] \item[] Creates a new packet with data as noted in parameters.
