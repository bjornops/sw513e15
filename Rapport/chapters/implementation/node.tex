...
\end{lstlisting}
attemptNumber is capped at 32, as there is 32 bits in the datatype \texttt{long} on the arduino, and bitshifting out of the bound could give unwanted results.
