...
algorithm:
r degree of G: append r zeroes to the lower end of M, s.t. $M+R = Mx^r$
divide $Mx^r$ by G, using mod 2/binary division
Subtract remainder from $Mx^r$ using binary subtraction
