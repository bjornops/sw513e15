...
To fulfill the requirements found in \ref{cha:requirements}, there is no demand to measure one specific node at a time.
...
Following are the five \todo{4 eller 5} packets described.
