...
The sizes of the different data to transfer sums up to 16 bytes. The distribution is displayed in \figref{dataalloc}, where the abbreviations are accordingly for packet type, addresser, addressee, origin address, sensor data 1 through 3, and checksum.
