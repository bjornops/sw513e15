...
In other words, a tree instantiated by the controlled flooding protocol can be used to construct a tree that spans over all paths\todo{ALL paths?} from each node to the main node.
