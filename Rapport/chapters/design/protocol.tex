...
To ensure that a packet with the correct checksum will arrive at some point, the nodes will wait a random, but longer, interval, between attempting to send data known as exponential backoff. This means that at some point, the data will be transmitted to the receiver without interference. This is possible, as delivery time is not prioritized high. Exponential backoff is further explained in \ref{cha:expbackoff}
