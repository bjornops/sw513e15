...
If the radio module is listening and does not receive a packet within the listening duration, it will also return an \textit{error} packet and followingly discard it.\todo{last sentece is more implementation than design}
